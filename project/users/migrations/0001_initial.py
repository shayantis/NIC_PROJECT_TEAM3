# Generated by Django 5.0.6 on 2026-05-29 09:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_district', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.district')),
                ('to_district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_in', to='users.district')),
                ('transferred_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_made', to=settings.AUTH_USER_MODEL)),
